...
readxl::read_xlsx("./data/macroeconomic-indicators.xlsx", sheet = "macro-2020", range = "A2:E47") %>% 
  ...
  kableExtra::column_spec(column = 1:5, width = c("2em", "10em", "4em", "4em", "4em"))
```
