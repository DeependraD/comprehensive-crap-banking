...
- To provide loan to and invest in the shares of the institutions which carry out the functions helpful in carrying out the function of the Bank or in attaining its objectives, not exceeding ten percent of the total capital of such institutions. (warrents explaination)
- To provide loan to its own employees.

### Prior Right of the Bank (Section 6)
...
### Previlage and facilities of the Bank (Section 8)
...
- The board shall constitute an audit committee comprising of the following members
...
- After retirement, deputy governor cannot work in other BFIs at least for three years

### Functions, Duties, and power of Board ( Section 29)
...
- To frame necessary policies for causing the supervision and inspection of BFIs.
- To frame the applicable policies for other BFIs.
...
- To fix the amount, limit, terms and conditions about providing loan to the BFIs.
...
### Functions, Duties, and power of the Governor (Section 30)
...
- Fix the interest rate related policies of other BFIs.
- Formulate the policy related to the liquidity of the other BFIs.
- Formulate the terms and conditions of the gold and other precious metal related transactions.
- To fix the fees and commission of BFIs.
- To take the decision about operating and expanding the branches of the BFIs.
- To make the necessary arrangement for the development and operation of the information system of other banks.
...
### Function, Duties, and power of the audit committee (Section 35)
...
### Relation with Government of Nepal (Chapter 8, Section 69)
...
- Provide advice to the consultation relating to external debt
...
### State of problematic commercial banks and financial institution (Section 86B)

- Act against the interest of depositor, shareholder, and promoters.
- Act of not fulfilling the financial liabilities.
- If BFIs are going toward insolvency
- If BFIs submit the fake document and acknowledge later. (while getting a license)
- If BFIs are unable to maintain the capital structure and capital fund.
- If BFIs initiate the process of volunteer liquidation undue delay.
- If BFIs carry out the businesses which are restricted by NRB.
- Unable to pay the due amount.

### Action taken by NRB to problematic BFIs (Section 86C)
...
- It has the provision of incorporation of the company
...
- It has the provision relating to share, capita , and debenture of companies.
